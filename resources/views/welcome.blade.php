@extends('livewire.frontend.appfront')
        ...
        <div class="owl-carousel causes-carousel">
            <div class="causes-item">
                <div class="causes-img">
                    <img src="{{ asset('frontend/img/causes-1.jpg')}}" alt="Image">
                </div>
            ...
            <div class="causes-item">
                <div class="causes-img">
                    <img src="{{ asset('frontend/img/causes-2.jpg')}}" alt="Image">
                </div>
                <div class="causes-progress">
                    <div class="progress">
                        <div class="progress-bar" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">
            ...
            <div class="causes-item">
                <div class="causes-img">
                    <img src="{{ asset('frontend/img/causes-3.jpg')}}" alt="Image">
                </div>
                <div class="causes-progress">
                    <div class="progress">
                        <div class="progress-bar" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">
            ...
            <div class="causes-item">
                <div class="causes-img">
                    <img src="{{ asset('frontend/img/causes-4.jpg')}}" alt="Image">
                </div>
                <div class="causes-progress">
                    <div class="progress">
                        <div class="progress-bar" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="team-item">
                    <div class="team-img">
                        <img src="{{ asset('frontend/img/officials/lanre-oyeleke.jpeg')}}" alt="Team Image">
                    </div>
                    <div class="team-text">
                        <h2>Lanre Oyeleke</h2>
                        <p>Founder & CEO</p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-item">
                    <div class="team-img">
                        <img src="{{ asset('frontend/img/officials/temitope-oluwayanmi.jpeg')}}" alt="Team Image">
                    </div>
                    <div class="team-text">
                        <h2>Temitope Oluwayanmi</h2>
                        <p>Chef Executive</p>
                        <div class="team-social">
                            <a href=""><i class="fab fa-twitter"></i></a>
                            <a href=""><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-item">
                    <div class="team-img">
                        <img wire:click="showOfficial" src="{{ asset('frontend/img/officials/adeola-martins.jpeg')}}" alt="Team Image">
                    </div>
                    <div class="team-text">
                        <h2>Adeola Martins</h2>
                        <p>Chef Advisor</p>
                        <div class="team-social">
                            <a href=""><i class="fab fa-twitter"></i></a>
                            <a href=""><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-item">
                    <div class="team-img">
                        <img wire:click="" src="{{ asset('frontend/img/officials/tosin-omojola.jpeg')}}" alt="Team Image">
                    </div>
                    <div class="team-text">
                        <h2>James Alien</h2>
                        <p>Advisor</p>
